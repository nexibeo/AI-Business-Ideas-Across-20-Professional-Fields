...
<img src="logos/content-refresh-subscription.svg" alt="Content refresh subscription logo concept" width="360">

- Colors: `#382791` primary · `#c9c554` accent · `#e7e4f1` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Energetic, specific, results-minded
- Demo site: [https://nexibeo.com/solutions/content-refresh-subscription/demo/](https://nexibeo.com/solutions/content-refresh-subscription/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/content-refresh-subscription/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/content-refresh-subscription/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
