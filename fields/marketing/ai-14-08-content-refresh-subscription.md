...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: detect stale references; inspect broken links. Manual review in the loop. | 3 weeks | $5,000 |
...
| Full product | Remaining modules: draft updates; assign subject reviewers; record refresh dates. Self-serve onboarding, billing, monitoring and the wider integration set. | 6 weeks | $6,500 |
