...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: translate core messages; adapt examples. Manual review in the loop. | 5 weeks | $10,000 |
...
| Full product | Remaining modules: preserve claims; localize landing pages; coordinate regional approval. Self-serve onboarding, billing, monitoring and the wider integration set. | 12 weeks | $17,500 |
