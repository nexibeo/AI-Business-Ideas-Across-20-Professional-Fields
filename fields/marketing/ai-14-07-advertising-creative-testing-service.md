...
<img src="logos/advertising-creative-testing-service.svg" alt="Advertising creative testing service logo concept" width="360">

- Colors: `#282791` primary · `#c9a654` accent · `#e5e4f1` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Energetic, specific, results-minded
- Demo site: [https://nexibeo.com/ideas/advertising-creative-testing-service/demo/](https://nexibeo.com/ideas/advertising-creative-testing-service/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: isolate creative variables; label variants. Manual review in the loop. | 6 weeks | $11,500 |
...
| Full product | Remaining modules: prepare test batches; import results; document limitations. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $20,500 |
| **Total** | | 27 weeks | **$46,500** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/advertising-creative-testing-service/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/advertising-creative-testing-service/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
