...
<img src="logos/customer-case-study-studio.svg" alt="Customer case study studio logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/customer-case-study-studio/demo/](https://nexibeo.com/ideas/customer-case-study-studio/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: prepare interview questions; extract outcome narratives. Manual review in the loop. | 4 weeks | $7,000 |
...
| Full product | Remaining modules: draft stories; coordinate customer approval; adapt sales formats. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 weeks | $11,000 |
...
**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/customer-case-study-studio/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/customer-case-study-studio/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
