...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: answer opening-hour questions; explain booking steps. Manual review in the loop. | 6 weeks | $11,000 |
...
| Full product | Remaining modules: route clinical questions; support approved languages; track knowledge gaps. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $19,500 |
