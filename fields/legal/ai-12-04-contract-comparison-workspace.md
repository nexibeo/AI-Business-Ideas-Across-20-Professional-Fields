...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: align clauses; detect moved sections. Manual review in the loop. | 5 weeks | $10,000 |
...
| Full product | Remaining modules: preserve originals; group changes by topic; export review annotations. Self-serve onboarding, billing, monitoring and the wider integration set. | 12 weeks | $18,000 |
