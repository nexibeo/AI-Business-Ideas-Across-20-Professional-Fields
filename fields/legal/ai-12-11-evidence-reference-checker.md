...
<img src="logos/evidence-reference-checker.svg" alt="Evidence reference checker logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/evidence-reference-checker/demo/](https://nexibeo.com/ideas/evidence-reference-checker/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: extract factual claims; resolve cited locations. Manual review in the loop. | 5 weeks | $10,000 |
...
| Full product | Remaining modules: flag missing references; distinguish contradiction; record lawyer judgments. Self-serve onboarding, billing, monitoring and the wider integration set. | 12 weeks | $18,000 |
| **Total** | | 24 weeks | **$41,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/evidence-reference-checker/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/evidence-reference-checker/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
