...
<img src="logos/benefits-information-navigator.svg" alt="Benefits information navigator logo concept" width="360">

- Colors: `#279166` primary · `#c95468` accent · `#e4f1ec` surface · `#22201e` ink
- Type: Archivo for headings, Lora for text
- Voice: Fair, human, straightforward
- Demo site: [https://nexibeo.com/solutions/benefits-information-navigator/demo/](https://nexibeo.com/solutions/benefits-information-navigator/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/benefits-information-navigator/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/benefits-information-navigator/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
