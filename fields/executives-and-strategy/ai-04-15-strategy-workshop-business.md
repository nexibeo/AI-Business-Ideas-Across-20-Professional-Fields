...
<img src="logos/strategy-workshop-business.svg" alt="Strategy workshop business logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: collect pre-work; prepare evidence prompts. Manual review in the loop. | 4 days | $7,500 |
...
| Full product | Remaining modules: compare participant assumptions; document decisions; assign follow-up reviews. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 days | $12,000 |
