...
<img src="logos/team-capacity-planner.svg" alt="Team capacity planner logo concept" width="360">

- Colors: `#275591` primary · `#c9aa54` accent · `#e4eaf1` surface · `#22201e` ink
- Type: Archivo for headings, Lora for text
- Voice: Practical, organised, candid
- Demo site: [https://nexibeo.com/solutions/team-capacity-planner/demo/](https://nexibeo.com/solutions/team-capacity-planner/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: normalize work estimates; account for leave. Manual review in the loop. | 5 days | $9,000 |
...
| Full product | Remaining modules: flag overload; model reassignment; capture manager decisions. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 days | $14,500 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/team-capacity-planner/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/team-capacity-planner/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
