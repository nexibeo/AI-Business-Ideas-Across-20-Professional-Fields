...
<img src="logos/reference-verification-service.svg" alt="Reference verification service logo concept" width="360">
...
- Demo site: [https://nexibeo.com/solutions/reference-verification-service/demo/](https://nexibeo.com/solutions/reference-verification-service/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: resolve bibliographic records; check quoted text. Manual review in the loop. | 3 days | $7,000 |
...
| Full product | Remaining modules: flag unavailable sources; identify retraction notices when supplied; record reviewer decisions. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 days | $10,000 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/reference-verification-service/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/reference-verification-service/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
