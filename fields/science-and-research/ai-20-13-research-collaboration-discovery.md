...
<img src="logos/research-collaboration-discovery.svg" alt="Research collaboration discovery logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/research-collaboration-discovery/demo/](https://nexibeo.com/ideas/research-collaboration-discovery/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: define capability gaps; identify relevant teams. Manual review in the loop. | 4 weeks | $8,000 |
...
| Full product | Remaining modules: compare complementary methods; flag outdated affiliations; prepare collaboration concepts. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $12,000 |
| **Total** | | 19 weeks | **$29,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/research-collaboration-discovery/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/research-collaboration-discovery/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
