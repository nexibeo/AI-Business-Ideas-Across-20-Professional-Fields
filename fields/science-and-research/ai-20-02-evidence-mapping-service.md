...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: define extraction fields; code study methods. Manual review in the loop. | 4 weeks | $7,500 |
...
| Full product | Remaining modules: capture reported outcomes; track reviewer disagreements; export structured evidence. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $12,000 |
