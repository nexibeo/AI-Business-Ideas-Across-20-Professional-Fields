...
<img src="logos/policy-change-tracking-tool.svg" alt="Policy change tracking tool logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: align clauses; ignore layout-only changes. Manual review in the loop. | 6 days | $10,000 |
...
| Full product | Remaining modules: preserve original text; group affected topics; export review notes. Self-serve onboarding, billing, monitoring and the wider integration set. | 2 weeks | $17,500 |
