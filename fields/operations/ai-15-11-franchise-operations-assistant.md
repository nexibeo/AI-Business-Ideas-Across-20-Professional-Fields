...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: retrieve current procedures; apply location context. Manual review in the loop. | 3 weeks | $5,000 |
...
| Full product | Remaining modules: show effective dates; flag conflicts; route headquarters questions. Self-serve onboarding, billing, monitoring and the wider integration set. | 6 weeks | $6,000 |
