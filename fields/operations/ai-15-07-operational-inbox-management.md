...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: classify messages; extract deadlines. Manual review in the loop. | 4 weeks | $7,000 |
...
| Full product | Remaining modules: detect missing information; draft replies; assign responsible teams. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 weeks | $10,000 |
