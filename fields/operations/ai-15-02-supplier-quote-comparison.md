...
<img src="logos/supplier-quote-comparison.svg" alt="Supplier quote comparison logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: normalize units; align specifications. Manual review in the loop. | 3 days | $6,000 |
...
| Full product | Remaining modules: compare delivery terms; flag currency differences; draft supplier questions. Self-serve onboarding, billing, monitoring and the wider integration set. | 6 days | $8,000 |
