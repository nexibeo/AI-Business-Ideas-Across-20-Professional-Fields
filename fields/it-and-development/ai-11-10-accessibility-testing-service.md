...
<img src="logos/accessibility-testing-service.svg" alt="Accessibility testing service logo concept" width="360">

- Colors: `#277f91` primary · `#c97454` accent · `#e4eff1` surface · `#22201e` ink
- Type: Archivo for headings, Lora for text
- Voice: Technical, direct, no hype
- Demo site: [https://nexibeo.com/solutions/accessibility-testing-service/demo/](https://nexibeo.com/solutions/accessibility-testing-service/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/accessibility-testing-service/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/accessibility-testing-service/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
