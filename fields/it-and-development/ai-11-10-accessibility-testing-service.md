...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: run automated checks; inspect keyboard flows. Manual review in the loop. | 5 weeks | $8,500 |
...
| Full product | Remaining modules: document user impact; prioritize fixes; retest remediations. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 weeks | $14,000 |
