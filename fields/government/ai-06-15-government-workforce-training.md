...
<img src="logos/government-workforce-training.svg" alt="Government workforce training logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: map approved use cases; create task exercises. Manual review in the loop. | 6 weeks | $12,000 |
