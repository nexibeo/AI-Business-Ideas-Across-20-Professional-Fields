...
<img src="logos/public-consultation-analyzer.svg" alt="Public consultation analyzer logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/public-consultation-analyzer/demo/](https://nexibeo.com/ideas/public-consultation-analyzer/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: classify responses; preserve minority views. Manual review in the loop. | 5 weeks | $11,000 |
...
| Full product | Remaining modules: link quoted evidence; distinguish frequency from importance; export transparent summaries. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $19,000 |
| **Total** | | 25 weeks | **$44,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/public-consultation-analyzer/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/public-consultation-analyzer/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
