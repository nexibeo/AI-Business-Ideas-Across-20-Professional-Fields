...
<img src="logos/public-records-search-assistant.svg" alt="Public records search assistant logo concept" width="360">

- Colors: `#359127` primary · `#9e54c9` accent · `#e6f1e4` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Plain-spoken, neutral, accountable
- Demo site: [https://nexibeo.com/solutions/public-records-search-assistant/demo/](https://nexibeo.com/solutions/public-records-search-assistant/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/public-records-search-assistant/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/public-records-search-assistant/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
