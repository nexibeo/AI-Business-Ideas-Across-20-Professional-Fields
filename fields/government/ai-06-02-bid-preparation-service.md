...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: extract mandatory questions; map evidence. Manual review in the loop. | 6 weeks | $11,000 |
...
| Full product | Remaining modules: flag unsupported claims; track word limits; assemble submission packs. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $20,000 |
| **Total** | | 27 weeks | **$45,500** |
