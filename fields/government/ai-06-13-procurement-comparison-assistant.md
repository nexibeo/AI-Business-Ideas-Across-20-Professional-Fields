...
<img src="logos/procurement-comparison-assistant.svg" alt="Procurement comparison assistant logo concept" width="360">

- Colors: `#2f9127` primary · `#c954c7` accent · `#e6f1e4` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Plain-spoken, neutral, accountable
- Demo site: [https://nexibeo.com/ideas/procurement-comparison-assistant/demo/](https://nexibeo.com/ideas/procurement-comparison-assistant/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: map proposal sections; identify omissions. Manual review in the loop. | 5 weeks | $11,000 |
...
| Full product | Remaining modules: cite supplier claims; capture evaluator judgments; preserve assessment history. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $19,000 |
| **Total** | | 25 weeks | **$44,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/procurement-comparison-assistant/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/procurement-comparison-assistant/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
