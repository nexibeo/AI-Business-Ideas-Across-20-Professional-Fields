...
<img src="logos/public-service-translation-studio.svg" alt="Public service translation studio logo concept" width="360">

- Colors: `#3f9127` primary · `#ac54c9` accent · `#e7f1e4` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Plain-spoken, neutral, accountable
- Demo site: [https://nexibeo.com/solutions/public-service-translation-studio/demo/](https://nexibeo.com/solutions/public-service-translation-studio/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: translate instructions; preserve official names. Manual review in the loop. | 7 days | $12,000 |
...
| Full product | Remaining modules: adapt reading level; validate form layout; manage version updates. Self-serve onboarding, billing, monitoring and the wider integration set. | 3 weeks | $21,500 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/public-service-translation-studio/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/public-service-translation-studio/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
