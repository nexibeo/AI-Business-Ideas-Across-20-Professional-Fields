...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: identify service intent; retrieve approved guidance. Manual review in the loop. | 5 weeks | $10,000 |
...
| Full product | Remaining modules: explain next steps; flag unavailable answers; route staff help. Self-serve onboarding, billing, monitoring and the wider integration set. | 12 weeks | $17,000 |
