...
<img src="logos/open-data-reporting-service.svg" alt="Open data reporting service logo concept" width="360">

- Colors: `#4a9127` primary · `#ba54c9` accent · `#e9f1e4` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Plain-spoken, neutral, accountable
- Demo site: [https://nexibeo.com/ideas/open-data-reporting-service/demo/](https://nexibeo.com/ideas/open-data-reporting-service/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: validate dataset definitions; harmonize periods. Manual review in the loop. | 5 weeks | $11,000 |
...
| Full product | Remaining modules: explain limitations; schedule refreshes; export member briefs. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $19,000 |
| **Total** | | 25 weeks | **$44,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/open-data-reporting-service/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/open-data-reporting-service/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
