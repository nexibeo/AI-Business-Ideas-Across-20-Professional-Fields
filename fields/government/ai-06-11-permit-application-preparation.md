...
<img src="logos/permit-application-preparation.svg" alt="Permit application preparation logo concept" width="360">

- Colors: `#4f9127` primary · `#8d54c9` accent · `#e9f1e4` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Plain-spoken, neutral, accountable
- Demo site: [https://nexibeo.com/solutions/permit-application-preparation/demo/](https://nexibeo.com/solutions/permit-application-preparation/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: select permit category; extract required fields. Manual review in the loop. | 6 days | $11,000 |
...
| Full product | Remaining modules: cross-check identifiers; track checklist versions; assemble applicant review. Self-serve onboarding, billing, monitoring and the wider integration set. | 3 weeks | $20,500 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/permit-application-preparation/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/permit-application-preparation/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
