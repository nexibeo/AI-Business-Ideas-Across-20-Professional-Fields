...
<img src="logos/proactive-service-update-platform.svg" alt="Proactive service update platform logo concept" width="360">

- Colors: `#915527` primary · `#548bc9` accent · `#f1eae4` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Warm, clear, calm under pressure
- Demo site: [https://nexibeo.com/ideas/proactive-service-update-platform/demo/](https://nexibeo.com/ideas/proactive-service-update-platform/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: map affected audiences; draft status messages. Manual review in the loop. | 4 weeks | $8,000 |
...
| Full product | Remaining modules: coordinate channels; record approvals; publish resolution summaries. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $13,000 |
| **Total** | | 19 weeks | **$30,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/proactive-service-update-platform/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/proactive-service-update-platform/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
