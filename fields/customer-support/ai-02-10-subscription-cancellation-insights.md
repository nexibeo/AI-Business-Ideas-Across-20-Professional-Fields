...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: normalize stated reasons; separate billing from product issues. Manual review in the loop. | 4 weeks | $7,000 |
...
| Full product | Remaining modules: compare cohorts; suggest testable changes; monitor subsequent trends. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 weeks | $10,500 |
