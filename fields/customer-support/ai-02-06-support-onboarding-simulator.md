...
<img src="logos/support-onboarding-simulator.svg" alt="Support onboarding simulator logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: simulate customer personalities; introduce policy exceptions. Manual review in the loop. | 4 weeks | $8,000 |
...
| Full product | Remaining modules: show missed steps; replay difficult turns; track skill development. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $12,500 |
