...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: identify device models; interpret approved error codes. Manual review in the loop. | 3 weeks | $5,500 |
...
| Full product | Remaining modules: record attempted actions; stop unsafe sequences; prepare repair handoffs. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 weeks | $7,500 |
