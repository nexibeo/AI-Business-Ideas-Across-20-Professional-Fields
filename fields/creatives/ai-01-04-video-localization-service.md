...
<img src="logos/video-localization-service.svg" alt="Video localization service logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/video-localization-service/demo/](https://nexibeo.com/ideas/video-localization-service/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: transcribe with speaker labels; edit translated subtitles. Manual review in the loop. | 6 weeks | $11,000 |
...
| Full product | Remaining modules: track voice permissions; check on-screen text; export caption and video versions. Self-serve onboarding, billing, monitoring and the wider integration set. | 13 weeks | $20,000 |
| **Total** | | 26 weeks | **$45,500** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/video-localization-service/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/video-localization-service/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
