...
<img src="logos/podcast-promotion-studio.svg" alt="Podcast promotion studio logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/podcast-promotion-studio/demo/](https://nexibeo.com/ideas/podcast-promotion-studio/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: identify self-contained segments; preserve quote context. Manual review in the loop. | 6 weeks | $12,000 |
...
| Full product | Remaining modules: generate cover variants; adapt aspect ratios; package episode promotion schedules. Self-serve onboarding, billing, monitoring and the wider integration set. | 14 weeks | $21,500 |
| **Total** | | 28 weeks | **$49,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/podcast-promotion-studio/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/podcast-promotion-studio/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
