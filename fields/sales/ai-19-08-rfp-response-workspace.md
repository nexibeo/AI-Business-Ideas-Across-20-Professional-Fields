...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: classify questions; retrieve approved answers. Manual review in the loop. | 3 weeks | $6,000 |
...
| Full product | Remaining modules: identify stale claims; assign specialist review; export response packages. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 weeks | $8,000 |
