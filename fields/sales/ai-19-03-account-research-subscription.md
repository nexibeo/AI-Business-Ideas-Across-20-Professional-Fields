...
<img src="logos/account-research-subscription.svg" alt="Account research subscription logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/account-research-subscription/demo/](https://nexibeo.com/ideas/account-research-subscription/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: collect verified company facts; track relevant developments. Manual review in the loop. | 3 weeks | $6,000 |
...
| Full product | Remaining modules: identify evidence gaps; draft conversation questions; refresh account briefs. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 weeks | $8,000 |
| **Total** | | 15 weeks | **$19,500** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/account-research-subscription/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/account-research-subscription/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
