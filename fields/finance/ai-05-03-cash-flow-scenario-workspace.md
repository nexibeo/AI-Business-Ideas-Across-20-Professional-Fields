...
<img src="logos/cash-flow-scenario-workspace.svg" alt="Cash-flow scenario workspace logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: validate opening balances; model payment timing. Manual review in the loop. | 5 days | $9,500 |
...
| Full product | Remaining modules: compare collection scenarios; expose shortfall dates; reconcile actual movements. Self-serve onboarding, billing, monitoring and the wider integration set. | 2 weeks | $17,000 |
