...
- Demo site: [https://nexibeo.com/ideas/finance-team-training-simulator/demo/](https://nexibeo.com/ideas/finance-team-training-simulator/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: create realistic discrepancies; provide investigation clues. Manual review in the loop. | 5 weeks | $10,000 |
...
| Full product | Remaining modules: explain accounting logic; score agreed criteria; track skills. Self-serve onboarding, billing, monitoring and the wider integration set. | 12 weeks | $17,500 |
...
**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/finance-team-training-simulator/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/finance-team-training-simulator/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
