...
<img src="logos/manuscript-consistency-review.svg" alt="Manuscript consistency review logo concept" width="360">

- Colors: `#913727` primary · `#54c9bd` accent · `#f1e6e4` surface · `#22201e` ink
- Type: Archivo for headings, Lora for text
- Voice: Literate, generous, editorial
- Demo site: [https://nexibeo.com/solutions/manuscript-consistency-review/demo/](https://nexibeo.com/solutions/manuscript-consistency-review/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/manuscript-consistency-review/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/manuscript-consistency-review/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
