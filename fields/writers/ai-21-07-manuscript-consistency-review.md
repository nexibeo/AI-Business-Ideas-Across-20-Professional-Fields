...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: build character records; map timeline claims. Manual review in the loop. | 4 weeks | $7,500 |
...
| Full product | Remaining modules: flag conflicting details; cite passages; record intentional exceptions. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $11,500 |
