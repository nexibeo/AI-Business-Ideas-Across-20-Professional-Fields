...
<img src="logos/case-study-writing-service.svg" alt="Case study writing service logo concept" width="360">

- Colors: `#913127` primary · `#54b4c9` accent · `#f1e6e4` surface · `#22201e` ink
- Type: Archivo for headings, Lora for text
- Voice: Literate, generous, editorial
- Demo site: [https://nexibeo.com/solutions/case-study-writing-service/demo/](https://nexibeo.com/solutions/case-study-writing-service/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: capture initial problem; document delivered work. Manual review in the loop. | 4 days | $8,000 |
...
| Full product | Remaining modules: draft narrative; obtain client approval; create proposal extracts. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 days | $13,500 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/case-study-writing-service/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/case-study-writing-service/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
