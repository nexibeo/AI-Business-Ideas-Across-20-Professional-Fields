...
<img src="logos/fiction-development-workshop.svg" alt="Fiction development workshop logo concept" width="360">
...
- Demo site: [https://nexibeo.com/solutions/fiction-development-workshop/demo/](https://nexibeo.com/solutions/fiction-development-workshop/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: explore plot consequences; test character motivations. Manual review in the loop. | 4 days | $8,500 |
...
| Full product | Remaining modules: generate optional alternatives; preserve author choices; track revisions. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 days | $13,500 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/fiction-development-workshop/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/fiction-development-workshop/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
