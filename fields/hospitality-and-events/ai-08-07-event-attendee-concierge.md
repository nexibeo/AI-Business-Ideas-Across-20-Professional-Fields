...
<img src="logos/event-attendee-concierge.svg" alt="Event attendee concierge logo concept" width="360">
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: find sessions; explain venue routes. Manual review in the loop. | 3 days | $6,500 |
...
| Full product | Remaining modules: surface schedule changes; save attendee interests; route organizer help. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 days | $9,500 |
