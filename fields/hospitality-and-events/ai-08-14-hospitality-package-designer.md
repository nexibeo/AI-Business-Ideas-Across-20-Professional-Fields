...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: assemble package components; check date restrictions. Manual review in the loop. | 4 weeks | $8,500 |
...
| Full product | Remaining modules: compare pricing assumptions; generate offer descriptions; track package performance. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 weeks | $13,500 |
