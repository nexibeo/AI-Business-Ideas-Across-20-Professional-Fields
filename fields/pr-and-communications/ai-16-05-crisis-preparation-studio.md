...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: develop scenarios; assign response roles. Manual review in the loop. | 4 weeks | $7,500 |
...
| Full product | Remaining modules: draft holding statements; test escalation timing; document lessons. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $11,500 |
