...
<img src="logos/crisis-preparation-studio.svg" alt="Crisis preparation studio logo concept" width="360">

- Colors: `#5f2791` primary · `#9cc954` accent · `#ebe4f1` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Articulate, timely, composed
- Demo site: [https://nexibeo.com/solutions/crisis-preparation-studio/demo/](https://nexibeo.com/solutions/crisis-preparation-studio/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/crisis-preparation-studio/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/crisis-preparation-studio/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
