...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: translate core statements; preserve dates and names. Manual review in the loop. | 5 weeks | $10,000 |
