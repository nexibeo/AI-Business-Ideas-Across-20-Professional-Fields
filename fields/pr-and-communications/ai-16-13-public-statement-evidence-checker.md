...
<img src="logos/public-statement-evidence-checker.svg" alt="Public statement evidence checker logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/public-statement-evidence-checker/demo/](https://nexibeo.com/ideas/public-statement-evidence-checker/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: extract factual claims; locate supplied evidence. Manual review in the loop. | 4 weeks | $6,500 |
...
| Full product | Remaining modules: check dates and quantities; distinguish opinion; record reviewer decisions. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 weeks | $10,000 |
...
**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/public-statement-evidence-checker/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/public-statement-evidence-checker/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
