...
<img src="logos/reputation-issue-detection.svg" alt="Reputation issue detection logo concept" width="360">

- Colors: `#532791` primary · `#91c954` accent · `#eae4f1` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Articulate, timely, composed
- Demo site: [https://nexibeo.com/solutions/reputation-issue-detection/demo/](https://nexibeo.com/solutions/reputation-issue-detection/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: group related mentions; preserve source dates. Manual review in the loop. | 2 days | $5,500 |
...
| Full product | Remaining modules: flag uncertain identity matches; track spread; route analyst assessment. Self-serve onboarding, billing, monitoring and the wider integration set. | 6 days | $6,500 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/reputation-issue-detection/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/reputation-issue-detection/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
