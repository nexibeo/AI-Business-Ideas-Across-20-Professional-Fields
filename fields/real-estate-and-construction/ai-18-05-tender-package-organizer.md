...
<img src="logos/tender-package-organizer.svg" alt="Tender package organizer logo concept" width="360">

- Colors: `#91276e` primary · `#54c997` accent · `#f1e4ed` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Solid, practical, on-schedule
- Demo site: [https://nexibeo.com/ideas/tender-package-organizer/demo/](https://nexibeo.com/ideas/tender-package-organizer/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: classify tender files; extract submission requirements. Manual review in the loop. | 4 weeks | $8,500 |
...
| Full product | Remaining modules: link amendments; identify missing inputs; assemble bid checklists. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 weeks | $14,000 |
| **Total** | | 20 weeks | **$32,500** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/tender-package-organizer/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/tender-package-organizer/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
