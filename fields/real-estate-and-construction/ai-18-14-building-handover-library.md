...
<img src="logos/building-handover-library.svg" alt="Building handover library logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/building-handover-library/demo/](https://nexibeo.com/ideas/building-handover-library/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: index building assets; link relevant manuals. Manual review in the loop. | 4 weeks | $8,000 |
...
| Full product | Remaining modules: flag missing certificates; assign document owners; export searchable handover portals. Self-serve onboarding, billing, monitoring and the wider integration set. | 9 weeks | $12,500 |
| **Total** | | 19 weeks | **$29,500** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/building-handover-library/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/building-handover-library/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
