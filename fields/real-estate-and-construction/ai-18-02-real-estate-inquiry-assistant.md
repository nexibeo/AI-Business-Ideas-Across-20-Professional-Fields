...
<img src="logos/real-estate-inquiry-assistant.svg" alt="Real estate inquiry assistant logo concept" width="360">

- Colors: `#912773` primary · `#54c96a` accent · `#f1e4ed` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Solid, practical, on-schedule
- Demo site: [https://nexibeo.com/solutions/real-estate-inquiry-assistant/demo/](https://nexibeo.com/solutions/real-estate-inquiry-assistant/demo/)
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/real-estate-inquiry-assistant/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/real-estate-inquiry-assistant/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
