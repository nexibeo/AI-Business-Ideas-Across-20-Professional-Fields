...
<img src="logos/change-order-documentation.svg" alt="Change order documentation logo concept" width="360">

- Colors: `#912788` primary · `#70c954` accent · `#f1e4f0` surface · `#22201e` ink
- Type: Playfair Display for headings, Source Sans 3 for text
- Voice: Solid, practical, on-schedule
- Demo site: [https://nexibeo.com/solutions/change-order-documentation/demo/](https://nexibeo.com/solutions/change-order-documentation/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: capture change facts; link site evidence. Manual review in the loop. | 5 days | $8,500 |
...
| Full product | Remaining modules: record supplied cost impacts; preserve approval status; export review forms. Self-serve onboarding, billing, monitoring and the wider integration set. | 10 days | $14,000 |
...
**Get this built:** [contact Nexibeo](https://nexibeo.com/solutions/change-order-documentation/#apply). We build it with our AI software factory, usually in days to a few weeks, for you to run internally or offer to your clients.
...
- **Estimation and having it built:** see the full solution page on [nexibeo.com](https://nexibeo.com/solutions/change-order-documentation/) for more detail on estimation. Nexibeo builds it for you as a custom AI implementation, to run internally or to offer to your own clients.
