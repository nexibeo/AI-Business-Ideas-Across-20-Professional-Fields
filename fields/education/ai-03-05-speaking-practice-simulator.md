...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: simulate audience questions; time answers. Manual review in the loop. | 3 weeks | $5,500 |
...
| Full product | Remaining modules: give rubric feedback; compare practice attempts; assign targeted drills. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 weeks | $7,000 |
