...
<img src="logos/tutor-administration-assistant.svg" alt="Tutor administration assistant logo concept" width="360">
...
- Demo site: [https://nexibeo.com/ideas/tutor-administration-assistant/demo/](https://nexibeo.com/ideas/tutor-administration-assistant/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: structure session notes; draft homework. Manual review in the loop. | 3 weeks | $6,000 |
...
| Full product | Remaining modules: prepare progress summaries; schedule reminders; approve parent messages. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 weeks | $8,000 |
| **Total** | | 15 weeks | **$20,000** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/tutor-administration-assistant/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/tutor-administration-assistant/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
