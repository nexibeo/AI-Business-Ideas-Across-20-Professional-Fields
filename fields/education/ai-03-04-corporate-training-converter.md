...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: break procedures into lessons; generate demonstrations. Manual review in the loop. | 5 weeks | $10,500 |
...
| Full product | Remaining modules: assign role paths; record completion; flag source changes. Self-serve onboarding, billing, monitoring and the wider integration set. | 12 weeks | $18,500 |
