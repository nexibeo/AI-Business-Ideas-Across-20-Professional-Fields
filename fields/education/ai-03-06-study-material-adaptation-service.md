...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: simplify sentences; explain unfamiliar terms. Manual review in the loop. | 3 weeks | $5,500 |
...
| Full product | Remaining modules: add examples; produce parallel versions; flag meaning changes. Self-serve onboarding, billing, monitoring and the wider integration set. | 7 weeks | $7,000 |
