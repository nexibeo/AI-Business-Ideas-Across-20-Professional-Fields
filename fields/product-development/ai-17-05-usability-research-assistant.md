...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: tag observed struggles; link clips to tasks. Manual review in the loop. | 4 weeks | $6,500 |
...
| Full product | Remaining modules: group issues; capture researcher judgments; export findings. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 weeks | $8,500 |
