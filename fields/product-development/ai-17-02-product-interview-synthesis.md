...
<img src="logos/product-interview-synthesis.svg" alt="Product interview synthesis logo concept" width="360">

- Colors: `#852791` primary · `#5cc954` accent · `#efe4f1` surface · `#22201e` ink
- Type: Archivo for headings, Lora for text
- Voice: Curious, rigorous, user-led
- Demo site: [https://nexibeo.com/ideas/product-interview-synthesis/demo/](https://nexibeo.com/ideas/product-interview-synthesis/demo/)
...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: transcribe interviews; tag research questions. Manual review in the loop. | 4 weeks | $6,500 |
...
| Full product | Remaining modules: preserve contradictory accounts; connect findings to quotes; identify open questions. Self-serve onboarding, billing, monitoring and the wider integration set. | 8 weeks | $8,500 |
| **Total** | | 17 weeks | **$21,500** |

**Co-create this project with us:** [contact Nexibeo](https://nexibeo.com/ideas/product-interview-synthesis/#apply) and we build it with you.
...
- **Estimation and building this idea:** see the full idea page on [nexibeo.com](https://nexibeo.com/ideas/product-interview-synthesis/) for more detail on estimation, and to co-create and build this idea with Nexibeo.
