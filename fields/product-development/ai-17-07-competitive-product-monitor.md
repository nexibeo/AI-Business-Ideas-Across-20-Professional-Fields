...
|---|---|---|---|
| MVP | One buyer segment, one recurring use case; first modules: capture public changes; compare feature descriptions. Manual review in the loop. | 3 weeks | $5,000 |
...
| Full product | Remaining modules: record packaging shifts; preserve dated evidence; produce relevance briefs. Self-serve onboarding, billing, monitoring and the wider integration set. | 6 weeks | $6,000 |
